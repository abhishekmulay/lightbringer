...
public class JsonRecordReader {
    ...
    public Map<String, Set<String>> getInlinksMap() {
        Map<String, Set<String>> outLinksMap = null;
        Map<String, Set<String>> inlinksMap = null;
        try {
            outLinksMap = this.getOutLinksMap();
            inlinksMap = this.getInlinksMap(outLinksMap);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return inlinksMap;
    ...
    private Map<String, Set<String>> getInlinksMap(Map<String, Set<String>> outLinksMap) {
        ...
        try {
            ...
            File file = new File(inlinksMapOutputFilePath);
            if (!file.exists()) {
                try {
                    file.createNewFile();
                } catch (IOException e) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            inlinksMap = jsonRecordReader.getInlinksMap(outLinksMap);
        } catch (IOException e) {
            e.printStackTrace();
        }
