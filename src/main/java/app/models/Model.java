...
public class Model {
    ...
    public Model(CrawlableURL crawlableURL, String rawHtml, String content, Map<String, String> httpHeaders) {
    ...
    public Model(CrawlableURL crawlableURL, String rawHtml, String content, Map<String, String> httpHeaders, Set<CrawlableURL> crawlableUrlOutlinks) {
        this.crawlableURL = crawlableURL;
        this.rawHtml = rawHtml;
        this.content = content;
        this.httpHeaders = httpHeaders;
